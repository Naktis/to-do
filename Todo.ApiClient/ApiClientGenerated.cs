...
namespace Todo.ApiClient
{
    ...
    public partial class ClientsClass
    {
        ...
        public ClientsClass(string baseUrl)
        {
            BaseUrl = baseUrl;
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task ApiClientsProjectsPostAsync(int clientID, string name)
        {
            return ApiClientsProjectsPostAsync(clientID, name, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task ApiClientsProjectsPostAsync(int clientID, string name, System.Threading.CancellationToken cancellationToken)
        {
            if (clientID == null)
                throw new System.ArgumentNullException("clientID");
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<Project> ApiClientsProjectsDeleteAsync(int projectID, string clientID)
        {
            return ApiClientsProjectsDeleteAsync(projectID, clientID, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<Project> ApiClientsProjectsDeleteAsync(int projectID, string clientID, System.Threading.CancellationToken cancellationToken)
        {
            if (projectID == null)
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task ApiClientsProjectsPutAsync(int clientID, int projectID)
        {
            return ApiClientsProjectsPutAsync(clientID, projectID, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task ApiClientsProjectsPutAsync(int clientID, int projectID, System.Threading.CancellationToken cancellationToken)
        {
            if (clientID == null)
                throw new System.ArgumentNullException("clientID");
